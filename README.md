...
This repository contains the files for a text classification machine learning model based on the information in the wine reviews from 1988 to 2020 included in the *Wine Spectator* Top 100 wine lists. Below are resources referenced for the project.
